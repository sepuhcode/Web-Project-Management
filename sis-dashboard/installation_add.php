                ...
                <form method="POST" class="task-form">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="progress" min="0" max="100" placeholder="0 - 100" required>
                        </div>
                        <div class="form-group">
                            <label>Status *</label>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" name="cable_type" placeholder="e.g. Cat6">
                            </div>
                            <div class="form-group">
                                <label>Cable Length (m)</label>
                                <input type="number" step="0.1" name="cable_length" placeholder="e.g. 50">
                            </div>
                            <div class="form-group">
                                <label>Connection Type</label>
                                <input type="text" name="connection_type" placeholder="e.g. RJ45">
                            </div>
                            <div class="form-group">
                                <label>Cable Label</label>
                                <input type="text" name="cable_label" placeholder="e.g. C-01">
                            </div>
                        </div>
                    </div>
